...
import {DueMultisigWallet} from "../../src/DueMultisigWallet.sol";

/// @dev WARNING! This mock is strictly intended for testing purposes only.
/// Do NOT copy anything here into production code unless you really know what you are doing.
contract MockDueSmartWallet is DueMultisigWallet {
    constructor() {
        // allow for easier testing
        _getMultisigStorage().nextSignerIndex = 0;
        _getMultisigStorage().nextCredentialIndex[0] = 0;
    }
