...
abstract contract ERC1271 {
    ...
    bytes32 private constant _MESSAGE_TYPEHASH = keccak256("DueSmartWalletMessage(bytes32 hash)");

    bytes4 constant ERC1271_VALID_SIGNATURE = bytes4(keccak256("isValidSignature(bytes32,bytes)"));
